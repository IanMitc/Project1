...
public class InitializeDatabase {
    public static void main(String[] args) {
        ...
        expenseList.get(3).denyExpense((Manager) employeeDAO.getEmployee(2), "What in the world is wrong with you!");
        expenseList.get(4).approveExpense((Manager) employeeDAO.getEmployee(8), "Man, that was a great party.");
        expenseList.get(5).approveExpense((Manager) employeeDAO.getEmployee(9), "Dear God, not Jonty!!!");
...
//            } else if (i > expenseList.size() / 2) {
//                expenseList.get(i).approveExpense((Manager) employeeDAO.getEmployee(4), "Sure thing");
//            }
//        }
//
//        for (Expense expense : expenseList) {
